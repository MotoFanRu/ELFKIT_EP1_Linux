...
if(ARM_MODE STREQUAL "Thumb")
	set(CMAKE_C_COMPILER "${P2K_EP1_TOOLCHAIN_ROOT}${BIN_DIRECTORY}/tcc")
	set(CMAKE_CXX_COMPILER "${P2K_EP1_TOOLCHAIN_ROOT}${BIN_DIRECTORY}/tcpp")
elseif(ARM_MODE STREQUAL "ARM")
	set(CMAKE_C_COMPILER "${P2K_EP1_TOOLCHAIN_ROOT}${BIN_DIRECTORY}/armcc")
	set(CMAKE_CXX_COMPILER "${P2K_EP1_TOOLCHAIN_ROOT}${BIN_DIRECTORY}/armcpp")
else()
	message(FATAL_ERROR "Please set '$ARM_MODE' to 'Thumb' or 'ARM'!")
endif()
set(CMAKE_ASM_COMPILER "${P2K_EP1_TOOLCHAIN_ROOT}${BIN_DIRECTORY}/armasm")
set(CMAKE_AR "${P2K_EP1_TOOLCHAIN_ROOT}${BIN_DIRECTORY}/armar")
set(CMAKE_C_LINK_EXECUTABLE "${P2K_EP1_TOOLCHAIN_ROOT}${BIN_DIRECTORY}/armlink")
set(CMAKE_CXX_LINK_EXECUTABLE "${P2K_EP1_TOOLCHAIN_ROOT}${BIN_DIRECTORY}/armlink")
if(WIN32)
