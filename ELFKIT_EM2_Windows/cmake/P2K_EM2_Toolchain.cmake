...
set(P2K_EM2_TOOLCHAIN_ROOT "${CMAKE_CURRENT_LIST_DIR}/..")

set(CMAKE_C_COMPILER "${P2K_EM2_TOOLCHAIN_ROOT}/bin/mcore-elf-gcc")
set(CMAKE_CXX_COMPILER "${P2K_EM2_TOOLCHAIN_ROOT}/bin/mcore-elf-g++")
#set(CMAKE_ASM_COMPILER "${P2K_EM2_TOOLCHAIN_ROOT}/bin/mcore-elf-as")
set(CMAKE_ASM_COMPILER "${P2K_EM2_TOOLCHAIN_ROOT}/bin/mcore-elf-gcc")
set(CMAKE_AR "${P2K_EM2_TOOLCHAIN_ROOT}/bin/mcore-elf-ar")
set(CMAKE_C_LINK_EXECUTABLE "${P2K_EM2_TOOLCHAIN_ROOT}/bin/mcore-elf-ld")
set(CMAKE_CXX_LINK_EXECUTABLE "${P2K_EM2_TOOLCHAIN_ROOT}/bin/mcore-elf-ld")
if(WIN32)
...
set(P2K_DIRECTORY_HEADERS_SDK "${P2K_EM2_TOOLCHAIN_ROOT}/SDK")
set(P2K_DIRECTORY_HEADERS_LIBRARIES "${P2K_EM2_TOOLCHAIN_ROOT}/SDK/lib")
set(P2K_DIRECTORY_LIBRARIES "${P2K_EM2_TOOLCHAIN_ROOT}/mcore-elf/lib")

set(P2K_GENERAL_DEFINES_FLAGS "-D__P2K__ -DEM2")
set(P2K_GENERAL_OPTIMIZATION_FLAGS "-O2")
set(P2K_LIB_C "libc.a")

set(P2K_GENERAL_C_FLAGS
	"-fshort-wchar -funsigned-char -fomit-frame-pointer -fno-builtin -m340 -m4align -mbig-endian -nostdinc -nostdlib")
set(P2K_GENERAL_CXX_FLAGS
	"-fshort-wchar -funsigned-char -fomit-frame-pointer -fno-builtin -m340 -m4align -mbig-endian -nostdinc -nostdlib")
set(P2K_GENERAL_ASM_FLAGS
	"-fshort-wchar -funsigned-char -fomit-frame-pointer -fno-builtin -m340 -m4align -mbig-endian -nostdinc -nostdlib")
set(P2K_GENERAL_C_LINK_FLAGS
	"${P2K_GENERAL_OPTIMIZATION_FLAGS} -d -EB -N -r -s -Bstatic -Bsymbolic -Bsymbolic-functions --gc-sections -nostdinc -nostdlib --unresolved-symbols=report-all -z muldefs -z combreloc -z nodefaultlib ")
